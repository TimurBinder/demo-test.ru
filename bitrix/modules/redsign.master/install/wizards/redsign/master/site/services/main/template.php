...
*/
if (!in_array($wizrdTemplateId, array("master")))
	$wizrdTemplateId = "master";
...
{
	copy(WIZARD_ABSOLUTE_PATH."/site/templates/al/assets/img/logo.png", WIZARD_SITE_PATH."include/logo.png");
	copy(WIZARD_ABSOLUTE_PATH."/site/templates/al/assets/img/logo_retina.png", WIZARD_SITE_PATH."include/logo_retina.png");
