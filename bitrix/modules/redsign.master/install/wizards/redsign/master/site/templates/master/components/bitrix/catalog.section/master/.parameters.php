...
// {
	// $arProductBlocks['rate'] = GetMessage('RS_MASTER_PRODUCT_BLOCK_RATE');
// }
...
$arTemplateParameters['SHOW_ERROR_SECTION_EMPTY'] = array(
	...
	'NAME' => getMessage('RS_MASTER_SHOW_ERROR_SECTION_EMPTY'),
	'TYPE' => 'CHECKBOX',
	'VALUE' => 'Y',
	'REFRESH' => 'Y',
	'DEFAULT' => 'N',
...
if ($arCurrentValues['SHOW_ERROR_SECTION_EMPTY'] === 'Y')
{
	$arTemplateParameters['MESS_ERROR_SECTION_EMPTY'] = array(
		'PARENT' => 'LIST_SETTINGS',
		'NAME' => GetMessage('RS_MASTER_MESS_ERROR_SECTION_EMPTY'),
		'TYPE' => 'STRING',
		'DEFAULT' => GetMessage('RS_MASTER_MESS_ERROR_SECTION_EMPTY_DEFAULT'),
	);
}
...
$arTemplateParameters['SHOW_OLD_PRICE'] = array(
	'PARENT' => 'VISUAL',
	'NAME' => GetMessage('RS.MASTER.SHOW_OLD_PRICE'),
	'TYPE' => 'CHECKBOX',
	'DEFAULT' => 'N'
);


if (isset($arCurrentValues['ADD_CONTAINER']) && $arCurrentValues['ADD_CONTAINER'] === 'Y')
{
	$arTemplateParameters['RS_SECTION_SHOW_BUTTON'] = array(
		'NAME' => Loc::getMessage('RS_SECTION_SHOW_BUTTON'),
		'TYPE' => 'CHECKBOX',
		'REFRESH' => 'Y',
		'DEFAULT' => 'Y',
	);

	if ($arCurrentValues['RS_SECTION_SHOW_BUTTON'] != 'N')
	{
		$arTemplateParameters['RS_SECTION_BUTTON_NAME'] = array(
			'NAME' => Loc::getMessage('RS_SECTION_BUTTON_NAME'),
			'TYPE' => 'STRING',
			'DEFAULT' => ''
		);

		$arTemplateParameters['RS_SECTION_BUTTON_LINK'] = array(
			'NAME' => Loc::getMessage('RS_SECTION_BUTTON_LINK'),
			'TYPE' => 'STRING',
			'DEFAULT' => ''
		);
	}
