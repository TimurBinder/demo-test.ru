...
if(COption::GetOptionString("redsign.master", "wizard_installed", "N", WIZARD_SITE_ID) == "Y" && !WIZARD_INSTALL_DEMO_DATA){
	if($wizard->GetVar('rewriteIndex', true) && $wizard->GetVar('siteLogoSet', true)){
		$iblockCode = "redsign_master_product_ask_".WIZARD_SITE_ID;
		$iblockType = "forms";
		...
		{
            CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/forms/product_ask/index.php", array("FORMS_PRODUCT_ASK_IBLOCK_ID" => $iblockID));
		}
	}
	return;
}
...
WizardServices::IncludeServiceLang("product_ask.php", $lang);
