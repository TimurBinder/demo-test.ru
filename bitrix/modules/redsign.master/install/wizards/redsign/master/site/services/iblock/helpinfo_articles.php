...
if(COption::GetOptionString("redsign.master", "wizard_installed", "N", WIZARD_SITE_ID) == "Y" && !WIZARD_INSTALL_DEMO_DATA){
	if($wizard->GetVar('rewriteIndex', true) && $wizard->GetVar('siteLogoSet', true)){
		$iblockCode = "redsign_master_articles_".WIZARD_SITE_ID;
		$iblockType = "helpinfo";
		...
		{
            CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/articles/index.php", array("HELPINFO_ARTICLES_IBLOCK_ID" => $iblockID));
            CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/helpinfo/index.php", array("HELPINFO_ARTICLES_IBLOCK_ID" => $iblockID));
            CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/_index.php", array("HELPINFO_ARTICLES_IBLOCK_ID" => $iblockID));
		}
	}
	return;
}
