...
<?php if ($arResult['ORDER_SUCCESS'] == 'Y'): ?>
    ...
    <div class="container-fluid">
        <div class="b-cart-empty">
            ...
            <h2 class="b-cart-empty__title"><?=Loc::getMessage('RS_LIGHTBASKET_ORDER_SUCCESS_TITLE');?></h2>
    ...
    <?php if (!empty($arParams['RS_VK_ID']) || !empty($arParams['RS_FB_PAGE'])): ?>
        <div class="container-fluid">
            <div class="l-community-widgets">
                <h2 class="l-community-widgets__title"><?=Loc::getMessage('RS_LIGHTBASKET_COMMUNITY_WIDGET_TITLE');?></h2>
