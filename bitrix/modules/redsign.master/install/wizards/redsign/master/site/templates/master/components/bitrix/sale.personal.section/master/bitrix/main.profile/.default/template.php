...
<div class="bx_profile">
	...
	?>
	<form method="post" name="form1" action="<?=$APPLICATION->GetCurUri()?>" enctype="multipart/form-data" role="form" class="rsform">
		...
		<div class="main-profile-block-shown" id="user_div_reg">
			...
			{
				?>
				<div class="form-group row field-wrap">
			...
			?>
			<div class="form-group row field-wrap">
				<label class="control-label col-sm-12 col-md-3 text-md-right" for="main-profile-name"><?=Loc::getMessage('NAME')?></label>
				<div class="col-sm-12">
					<input class="form-control" type="text" name="NAME" maxlength="50" id="main-profile-name" value="<?=$arResult["arUser"]["NAME"]?>" />
				</div>
			</div>
			<div class="form-group row field-wrap">
				<label class="control-label col-sm-12 col-md-3 text-md-right" for="main-profile-last-name"><?=Loc::getMessage('LAST_NAME')?></label>
				<div class="col-sm-12">
					<input class="form-control" type="text" name="LAST_NAME" maxlength="50" id="main-profile-last-name" value="<?=$arResult["arUser"]["LAST_NAME"]?>" />
				</div>
			</div>
			<div class="form-group row field-wrap">
				<label class="control-label col-sm-12 col-md-3 text-md-right" for="main-profile-second-name"><?=Loc::getMessage('SECOND_NAME')?></label>
				<div class="col-sm-12">
			...
			<div class="form-group row field-wrap">
				<label class="control-label col-sm-12 col-md-3 text-md-right" for="main-profile-email"><?=Loc::getMessage('EMAIL')?></label>
				<div class="col-sm-12">
			...
			if($arResult["arUser"]["EXTERNAL_AUTH_ID"] == '')
			{
				?>
				<div class="row">
					<p class="main-profile-form-password-annotation col-sm-9 small">
						<?echo $arResult["GROUP_POLICY"]["PASSWORD_REQUIREMENTS"];?>
					</p>
				</div>
				<div class="form-group row  field-wrap">
					<label class="control-label col-sm-12 col-md-3 text-md-right" for="main-profile-password"><?=Loc::getMessage('NEW_PASSWORD_REQ')?></label>
					<div class="col-sm-12">
				...
				<div class="form-group row  field-wrap">
					<label class="control-label main-profile-password col-sm-12 col-md-3 text-md-right" for="main-profile-password-confirm">
        ...
        <div class="row">
            <p class="main-profile-form-buttons-block col-sm-9">
