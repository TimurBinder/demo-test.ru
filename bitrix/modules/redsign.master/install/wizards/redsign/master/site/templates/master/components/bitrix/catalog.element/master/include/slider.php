...
*/
        ...
        if (!empty($actualItem['MORE_PHOTO']))
        {
            if (is_array($actualItem['MORE_PHOTO']) && count($actualItem['MORE_PHOTO']) > 0) {
                ...
                ?>
                <div class="owl-master product-item-detail-slider-images-container"<?/* if ($iSliderHeight > 0) { echo ' style="max-height:'.$iSliderHeight.'px"'; } */?> data-entity="images-container">
                    <?php
