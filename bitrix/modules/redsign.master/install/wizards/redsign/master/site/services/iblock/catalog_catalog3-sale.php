...
if ($IBLOCK_OFFERS_ID)
{
	$iblockCodeOffers = "redsign_master_offers_".WIZARD_SITE_ID;
	//IBlock fields
	$iblock = new CIBlock;
	$arFields = Array(
		"ACTIVE" => "Y",
...
//delete 1c props
    ...
    CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/cart/index.php", array("CATALOG_CATALOG_IBLOCK_ID" => $IBLOCK_CATALOG_ID));
    CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/cart/order/index.php", array("CATALOG_CATALOG_IBLOCK_ID" => $IBLOCK_CATALOG_ID));
    CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/catalog/index.php", array("CATALOG_CATALOG_IBLOCK_ID" => $IBLOCK_CATALOG_ID));
    CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/footer/cart.php", array("CATALOG_CATALOG_IBLOCK_ID" => $IBLOCK_CATALOG_ID));
    CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/footer/compare.php", array("CATALOG_CATALOG_IBLOCK_ID" => $IBLOCK_CATALOG_ID));
    CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/header/catalog_menu.php", array("CATALOG_CATALOG_IBLOCK_ID" => $IBLOCK_CATALOG_ID));
    CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/template/catalog/element_blocks.php", array("CATALOG_CATALOG_IBLOCK_ID" => $IBLOCK_CATALOG_ID));
    CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/template/order/popular.php", array("CATALOG_CATALOG_IBLOCK_ID" => $IBLOCK_CATALOG_ID));
    ...
    CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/wishlist/index.php", array("CATALOG_CATALOG_IBLOCK_ID" => $IBLOCK_CATALOG_ID));
    CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/_index.php", array("CATALOG_CATALOG_IBLOCK_ID" => $IBLOCK_CATALOG_ID));
    CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/sect_sidebar.php", array("CATALOG_CATALOG_IBLOCK_ID" => $IBLOCK_CATALOG_ID));
