...
if (!empty($arResult['ITEMS']))
{
  ...
  <div class="product-item-container" id=
		"<?=$strMainID;?>">
<!--		<div class="catalog-product-subscribe-list-close">-->
<!--			<span class="catalog-product-subscribe-list-close-item"></span>-->
<!--		</div>-->
	<div class="product-item <?=$showImgClass;?>">
	<a  href="<?=$arItem['DETAIL_PAGE_URL'];?>" class="product-item-image-wrapper">
      <span class="product-item-image-original" id="<?=$arItemIDs['PICT'];?>" <? if ($arParams['SHOW_IMAGE'] == "Y")
		{
    ...
    <div class="product-item-info-container" data-entity="buttons-block">
				<div class="product-item-button-container">
						<a class="btn btn-primary"  href="<?=$arItem['DETAIL_PAGE_URL'];?>" rel="nofollow"><?=GetMessage('CPSL_TPL_MESS_BTN_DETAIL');?></a>
            <a id="<?=$arItemIDs['SUBSCRIBE_DELETE_LINK'];?>" class="btn btn-gray" href="javascript:void(0)">
