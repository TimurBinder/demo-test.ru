...
$IBLOCK_CATALOG_ID = (isset($_SESSION["WIZARD_CATALOG_SERVICES_IBLOCK_ID"]) ? (int)$_SESSION["WIZARD_CATALOG_SERVICES_IBLOCK_ID"] : 0);
$IBLOCK_OFFERS_ID = (isset($_SESSION["WIZARD_OFFERS_SERVICES_IBLOCK_ID"]) ? (int)$_SESSION["WIZARD_OFFERS_SERVICES_IBLOCK_ID"] : 0);
//reference update
...
//delete 1c props
    ...
    CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/_index.php", array("CATALOG_SERVICES_IBLOCK_ID" => $IBLOCK_CATALOG_ID));
    CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/services/index.php", array("CATALOG_SERVICES_IBLOCK_ID" => $IBLOCK_CATALOG_ID));
}
?>