...
$beforeTitleProperty = (!empty($arParams['RS_BEFORE_TITLE_PROPERTY'])) ? $arParams['RS_BEFORE_TITLE_PROPERTY'] : 'BEFORE_TITLE';
...
foreach($arResult['ITEMS'] as &$arItem) {
    ...
    $arItem['PRODUCT_BEFORE_TITLE'] = $arItem['DISPLAY_PROPERTIES'][$beforeTitleProperty]['DISPLAY_VALUE'];
