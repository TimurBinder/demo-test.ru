...
?><!DOCTYPE html>
<html xml:lang="<?=LANGUAGE_ID?>" lang="<?=LANGUAGE_ID?>" class="<?=$fontSize?>">
<head>
...
<body class="<?=$fontFamily?> <?=$containerWidth?>" <?=$APPLICATION->ShowProperty("backgroundImage")?>>
    ...
    <div class="wrapper">
        ...
        ?>
        <div class="l-page<?=($isHomePage ? ' l-page--title-center' : '')?><?=$APPLICATION->ShowViewContent('has-sidebar')?><?=$APPLICATION->ShowViewContent('breadcrumb-center')?>">
