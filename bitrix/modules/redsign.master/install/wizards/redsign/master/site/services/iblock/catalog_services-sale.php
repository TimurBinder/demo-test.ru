...
if (in_array(LANGUAGE_ID, array('en', 'ru'))) {
    $iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH.'/xml/_all/catalog/services-sale-'.LANGUAGE_ID.'.xml';
	$iblockXMLFilePrices = WIZARD_SERVICE_RELATIVE_PATH.'/xml/_all/catalog/services-sale-prices-'.LANGUAGE_ID.'.xml';
} else {
	$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH.'/xml/_all/catalog/services-sale-ru.xml';
	$iblockXMLFilePrices = WIZARD_SERVICE_RELATIVE_PATH.'/xml/_all/catalog/services-sale-prices-ru.xml';
}
...
$iblockCode = "redsign_master_catalog_services_".WIZARD_SITE_ID;
$iblockType = "catalog";
...
else
{
	...
	$iBasePriceId = CCatalogGroup::Add($arFields);
}

if ((int)$iBasePriceId > 0)
{
	$SORTER_CATALOG_PRICE = 'catalog_price_scale_'.$iBasePriceId;
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/services/index.php", array("SORTER_CATALOG_PRICE" => $SORTER_CATALOG_PRICE));
}
...
if($IBLOCK_CATALOG_ID == false)
{
	...
	$_SESSION["WIZARD_CATALOG_SERVICES_IBLOCK_ID"] = $IBLOCK_CATALOG_ID;
}
else
{
	$arSites = array();
