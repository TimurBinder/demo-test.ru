...
if(COption::GetOptionString("redsign.master", "wizard_installed", "N", WIZARD_SITE_ID) == "Y" && !WIZARD_INSTALL_DEMO_DATA){
	if($wizard->GetVar('rewriteIndex', true) && $wizard->GetVar('siteLogoSet', true)){
		$iblockCode = "redsign_master_side_banners_".WIZARD_SITE_ID;
		$iblockType = "banners";
		...
		{
            CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/index/main_banners.php", array("BANNERS_SIDE_BANNERS_IBLOCK_ID" => $iblockID));
            CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/sect_sidebar.php", array("BANNERS_SIDE_BANNERS_IBLOCK_ID" => $iblockID));
		}
	}
	return;
}
...
WizardServices::IncludeServiceLang("side_banners.php", $lang);
