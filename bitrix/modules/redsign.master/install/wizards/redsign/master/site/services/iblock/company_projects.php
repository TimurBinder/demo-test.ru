...
if(COption::GetOptionString("redsign.master", "wizard_installed", "N", WIZARD_SITE_ID) == "Y" && !WIZARD_INSTALL_DEMO_DATA){
	if($wizard->GetVar('rewriteIndex', true) && $wizard->GetVar('siteLogoSet', true)){
		$iblockCode = "redsign_master_projects_".WIZARD_SITE_ID;
		$iblockType = "company";
		...
		{
            CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/projects/index.php", array("COMPANY_PROJECTS_IBLOCK_ID" => $iblockID));
		}
	}
	return;
}
