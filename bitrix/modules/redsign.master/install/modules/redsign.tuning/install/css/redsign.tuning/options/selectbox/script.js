$(document).ready(function() {
    ...
    $(document).on('click', '.rstuning__selectbox__option:not(.active)', function(e) {
        ...
        // $select.parents('.rstuning__option__selectbox').find('input').val($option.attr('value')).change();
        $select.parents('.rstuning__option__selectbox').find('input').val($option.attr('value'));
