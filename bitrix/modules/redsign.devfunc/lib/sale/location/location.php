...
class Location
{
    public const COOKIE_NAME = 'RS_MY_LOCATION';

    public static ?array $myCity = [];

    public static function getMyCity(): array
    {
        if (self::isBot()) {
            return [];
        }
        ...
        if (!self::$myCity) {
            ...
            $sCity = $request->getCookie(self::COOKIE_NAME);
    ...
    public static function getDefaultCity(string $siteId = SITE_ID): array
    {
    ...
    public static function getCityDataByName(string $name): ?array
    {
        if (!Loader::includeModule('sale'))
            throw new SystemException('Module sale not installed');
    ...
    public static function getCityDataByCode(string $code): array
    {
        return self::getCityData(['CODE' => $code]);
    }

    public static function getCityDataById(int $id): array
    {
        return self::getCityData(['ID' => $id]);
    }

    public static function getCityData(array $arFilter, array $arOrder = ['PARENT_CODE' => 'desc']): array
    {
        if (!Loader::includeModule('sale'))
            throw new SystemException('Module sale not installed');
    ...
    public static function setMyCity(int $id): void
    {
        if (!Loader::includeModule('sale'))
            throw new SystemException('Module sale not installed');
    ...
    public static function onSaleComponentOrderSetLocation(
        array &$arUserResult,
    ...
    public static function onGeoIpHandlersBuildList(): EventResult
    {
