...
class FavoriteList extends \CBitrixComponent implements Controllerable
{
    ...
    public const LIKES_COUNT_PROP = 'LIKES_COUNT';

    protected bool $useSale;
    ...
    public function addAction(array $post): array
    {
        $actionResult = [
            'STATUS' => 'OK',
            'ACTION' => 'ADD',
    ...
    public function removeAction(array $post): array
    {
        $actionResult = [
            'STATUS' => 'OK',
            'ACTION' => 'REMOVE',
    ...
    public function updateAction(array $post): array
    {
        return [];
    }
