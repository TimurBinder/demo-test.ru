...
*/?>
			<li class="pagination__link pagination__prev"><a href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=($arResult["NavPageNomer"]+1)?>"><svg class="icon-svg"><use xlink:href="#svg-chevron-left"></use></svg></a></li>
		<?else:?>
<?/*
			<li><a href="<?=$arResult["sUrlPath"]?><?=$strNavQueryStringFull?>"><?=GetMessage("nav_begin")?></a></li>
*/?>
			<?if ($arResult["NavPageCount"] == ($arResult["NavPageNomer"]+1) ):?>
				<li class="pagination__link pagination__prev"><a href="<?=$arResult["sUrlPath"]?><?=$strNavQueryStringFull?>"><svg class="icon-svg"><use xlink:href="#svg-chevron-left"></use></svg></a></li>
			<?else:?>
				<li class="pagination__link pagination__prev"><a href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=($arResult["NavPageNomer"]+1)?>"><svg class="icon-svg"><use xlink:href="#svg-chevron-left"></use></svg></a></li>
			<?endif?>
		<?endif?>
	...
	<?if ($arResult["NavPageNomer"] > 1):?>
		<li class="pagination__link pagination__next"><a href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=($arResult["NavPageNomer"]-1)?>" aria-label="Next">
...
*/?>
			<li class="pagination__link pagination__prev"><a href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=($arResult["NavPageNomer"]-1)?>">
...
*/?>
			...
			<?else:?>
				<li class="pagination__link pagination__prev"><a href="<?=$arResult["sUrlPath"]?><?=$strNavQueryStringFull?>">
                    <svg class="icon-svg" aria-hidden="true"><use xlink:href="#svg-chevron-left"></use></svg>
                </a></li>
			<?endif?>
