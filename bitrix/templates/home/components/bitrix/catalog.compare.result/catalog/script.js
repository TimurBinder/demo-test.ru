...
BX.Iblock.Catalog.CompareClass = (function()
{
	...
	CompareClass.prototype.sendRequest = function(result, data)
	{
		if (!data)
			return;
...
*/
	...
	CompareClass.prototype.compareItemDrag = function(x, y)
	{
	...
	CompareClass.prototype.compareItemDragStop = function()
	{
...
*/
	...
	CompareClass.prototype.compareItemDragInit = function()
	{
