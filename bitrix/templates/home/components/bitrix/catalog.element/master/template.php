...
if (!is_array($arResult['CATALOGS'][$arResult['IBLOCK_ID']]) && $arResult['MODULES']['redsign.master']) {
								...
								switch ($blockName)
								{
									case 'id-rate-stock':
                                        ...
                                        if (
                                            ...
                                            || $arParams['USE_STORE'] == 'Y' && ModuleManager::isModuleInstalled('catalog')
                                        ) {
                                ...
                                switch ($blockName) {
                                    ...
                                    case 'stock':
                                        if ($arParams['USE_STORE'] == 'Y' && $arResult['MODULES']['catalog'])
                                        {
                                            ...
                                            >
                                                <?php
                                                echo $APPLICATION->GetViewContent('product-item-detail__stocks');
...
/*
                                                    ...
                                                    include(MyTemplate::getTemplatePart($templateFolder.'/include/props/catalog.php'));
*/
            ...
            foreach ($arParams['BLOCK_LINES_ORDER'] as $blockName) {
                ...
                switch ($blockName) {
                    ...
                    case 'detail':
                        ...
                        if ($arResult['DETAIL_TEXT'] != '' || $arResult["PROPERTIES"]['KIND']['VALUE']):
                        ?>
                            <div class="row">
                                <div class="col-xs-12" id="<?=$blockName?>">
                                    ...
                                    <table cellspacing="0" cellpadding="0" align="center" class="table-master">
                                    <?
                                    $i=0;
                                    if($arResult["PROPERTIES"]['KIND']['VALUE'])
                                        foreach($arResult["PROPERTIES"]['KIND']['VALUE'] as $k => $v){
                                            if($i==0){
                                                $i++;?>
                                            	<tr>
                                        	...
                                        	<tr>
                                        		...
                                        		<td style="text-align: center;">
                                        			 <?=$arResult["PROPERTIES"]['MEASURE']['VALUE']?>
                                        		</td>
                                                <td style="text-align: center;">
                                        			 <?=$arResult["PROPERTIES"]['PRICE_KIND']['VALUE'][$k]?>
                                        		</td>
                                        	</tr>
                                    <?}?>
                                    </table>
...
if ($haveOffers)
{
	...
	foreach ($arResult['JS_OFFERS'] as $ind => &$jsOffer)
	{
        ...
        if (
            isset($arOffer['PROPERTIES'][$arParams['ARTNUMBER_PROP'][$arOffer['IBLOCK_ID']]])
            && $arOffer['PROPERTIES'][$arParams['ARTNUMBER_PROP'][$arOffer['IBLOCK_ID']]]['VALUE'] != ''
        ) {
            $arArtnum = $arOffer['PROPERTIES'][$arParams['ARTNUMBER_PROP'][$arOffer['IBLOCK_ID']]];
