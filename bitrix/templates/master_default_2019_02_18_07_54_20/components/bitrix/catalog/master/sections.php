...
$isSidebar = ($arParams["LIST_SHOW_SIDEBAR"] == "Y");
$isFilter = ($arParams['USE_FILTER'] == 'Y');
...
<?php
	...
	<?php
	if (
		$arParams['CATALOG_VIEW_MODE'] == 'VIEW_SECTIONS1'
...
*/?>
		...
		<?php if ($arParams['USE_FILTER'] == 'Y'): ?>
			<div class="catalog__filter-top filter_top">
				...
				<?php if (is_array($arResult['SECTION'][$arParams['FEATURE_FILTER_USER_FIELDS']]) && count($arResult['SECTION'][$arParams['FEATURE_FILTER_USER_FIELDS']]) > 0): ?>
					<div class="filter_top__box">

						<div class="filter_top__scroll scrollbar-inner">
							<?php foreach ($arResult['SECTION'][$arParams['FEATURE_FILTER_USER_FIELDS']] as $arFeatureFilter): ?>
								<?php
								$checked = false;
								...
								?>
								<?php if ($checked): ?>
									<a class="filter_top__item checked" href="<?=$arResult['SECTION']['SECTION_PAGE_URL'];?>">
										<span class="filter_top__btn"><?=$arFeatureFilter['UF_NAME'];?></span>
									</a>
								<?php else: ?>
									<a class="filter_top__item" href="<?=$arFeatureFilter['UF_LINK'];?>">
										<span class="filter_top__btn"><?=$arFeatureFilter['UF_NAME'];?></span>
									</a>
								<?php endif; ?>
							<?php endforeach; ?>
						</div>
						<div class="filter_top__nav scroll-element">
							<div class="scroll-arrow scroll-arrow_less prev"><svg class="icon-svg icon-svg-chevron-left"><use xlink:href="#svg-chevron-left"></use></svg></div>
							<div class="scroll-arrow scroll-arrow_more next"><svg class="icon-svg icon-svg-chevron-right"><use xlink:href="#svg-chevron-right"></use></svg></div>
		...
		<?php if ($arParams['USE_SORTER'] == 'Y'): ?>
			<div class="catalog__sorter">
				...
				$alfaTemplateRows = false;
				$alfaCOutput = isset($alfaCOutput) ? $alfaCOutput : $arParams["PAGE_ELEMENT_COUNT"];
