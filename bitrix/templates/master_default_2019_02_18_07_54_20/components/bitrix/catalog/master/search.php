...
*/?>
    ...
    <?php //else: ?>
        <?php //ShowError(getMessage('RS.MASTER.BC_MASTER.SEARCH_NO_RESULT')); ?>
    <?php //endif; ?>
</div>
...
$APPLICATION->SetTitle(getMessage('RS.MASTER.BC_MASTER.SEARCH_PAGE_TITLE'));
$APPLICATION->AddChainItem(getMessage('RS.MASTER.BC_MASTER.SEARCH_PAGE_TITLE') , $APPLICATION->GetCurPage());
