...
$arParams['DISPLAY_PICTURE'] = isset($arParams['DISPLAY_PICTURE']) && $arParams['DISPLAY_PICTURE'] == 'Y' ? 'Y' : 'N';
$arParams['DISPLAY_NAME'] = isset($arParams['DISPLAY_NAME']) && $arParams['DISPLAY_NAME'] == 'Y' ? 'Y' : 'N';
...
$arCharsRu = explode(' ', getMessage('RS.MASTER.BNL_TILES.LETTERS_RU'));
