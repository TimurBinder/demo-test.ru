	...
	else
	{
		if($arResult["is_ajax_post"] != "Y" && $arResult["CanUserComment"])
		{
			...
			<div id="form_comment_" style="display:none;">
				...
				<form class="rsform" method="POST" name="form_comment" id="<?=$component->createPostFormId()?>" action="<?=$ajaxPath; ?>">
                <div class="form rsfrom__form">
                        ...
                        <div class="row">
                            <div class="col col-xs-12 col-sm-6">
                                <div class="form-group field-wrap">
                                    <label for="user_name" class="control-label"><?=GetMessage("B_B_MS_NAME")?> <span class="required">*</span></label>
                                    <input class="form-control" maxlength="255" size="30" tabindex="3" type="text" name="user_name" id="user_name" value="<?=htmlspecialcharsEx($_SESSION["blog_user_name"])?>" required>
                                </div>
                            </div>
                            <div class="col col-xs-12 col-sm-6">
                                <div class="form-group field-wrap">
                    ...
                    <div class="row">
                        ...
                        <?/**/?>
                            <div class="form-group">
                                <div class="rsform__field-editor">
                        ...
                        <?/*?>
                            <div class="form-group field-wrap">
                                <label for="subject" class="control-label"><?=GetMessage("BPC_SUBJECT")?></label>
                                <textarea class="form-control" name="comment" id="POST_MESSAGE" style="height:200px"></textarea>
                            </div>
                            <?*/?>
                        </div>
                    </div>
                           ...
                           <div class="col col-md-12">
                               <div class="form-group field-wrap">
                                  <div class="captcha_wrap">
                                     <div class="rsform__captcha-label"><label for="captcha_word"><?=Loc::getMessage('B_B_MS_CAPTCHA_SYM'); ?> <span class="required">*</span></label></div>
                                     <div class="row">
                                        <div class="rsform__captcha-input col col-md-6 col-xs-12">
                                           ...
                                           <input class="form-control req-input form-item" type="text" size="30" name="captcha_word" id="captcha_word" value=""  tabindex="7" required>
                                        </div>
