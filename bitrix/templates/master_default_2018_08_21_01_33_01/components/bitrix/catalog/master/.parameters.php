...
$arTemplateParameters = array(
    ...
    'SECTIONS_SHOW_SIDEBAR' => array(
        'PARENT' => 'SECTIONS_SETTINGS',
        'NAME' => getMessage('RS.MASTER.SHOW_SIDEBAR'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'Y',
    ),
    'LIST_SHOW_SIDEBAR' => array(
        'PARENT' => 'LIST_SETTINGS',
        'NAME' => getMessage('RS.MASTER.SHOW_SIDEBAR'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'Y',
    ),
    'DETAIL_SHOW_SIDEBAR' => array(
...
if (!$boolCatalog && $boolLightBasket) {
...
if ($boolCatalog || $boolLightBasket)
{
    if ($arCurrentValues['IS_USE_CART'] == 'Y') {
        // $addToBasketActions['BUY'] = GetMessage('ADD_TO_BASKET_ACTION_BUY');
        $addToBasketActions['ADD'] = GetMessage('ADD_TO_BASKET_ACTION_ADD');
    }
/*
...
$addToBasketActions['ASK'] = GetMessage('RS.MASTER.ASK_QUESTION');
