                                    ...
                                    case 'buttons':
                                        ...
                                        ?>
                                            <div class="product-item-detail-info-container product-item-detail-info-container-buttons" data-entity="main-button-container">
                                                ...
                                                {   
													// выбор формы заказа товара с выбором цвета если указана хоть одна цена цвета
											    	if (is_array($arResult['PROPERTIES']['PRICE_COLOR']['VALUE']) && count($arResult['PROPERTIES']['PRICE_COLOR']['VALUE']) > 0) {
											    		include(getTemplatePart($templateFolder.'/include/info/buttons_tile.php'));	
													}
													// иначе без выбора цвета
													else {
