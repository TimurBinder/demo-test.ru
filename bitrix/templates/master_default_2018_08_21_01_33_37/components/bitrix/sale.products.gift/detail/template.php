...
$containerId = 'products-gift';
$containerName = 'sale-products-gift-container';
$containerAnchorName = 'sale-products-gift-anchor';

?>

<?php $this->SetViewTarget('product-item-detail__gifts'); ?>

<div data-entity="parent-container" id="<?=$containerId?>">
<section class="sale-products-gift" data-entity="<?=$containerName?>">
...
<?php endif; ?>
    ...
    <?php if ($arParams['SHOW_PARENT_NAME'] == 'Y' && strlen($arParams['PARENT_NAME']) > 0): ?>
        <h2 class="l-section__name h3" data-entity="header" data-showed="false" style="display: none; opacity: 0;"><?=$arParams['PARENT_NAME']?></h2>
    <?php endif; ?>
...
<?php $this->SetViewTarget('product-item-detail__gift'); ?>
    <a class="gift-link" data-entity="<?=$containerAnchorName?>" style="display:none" href="#<?=$containerId?>">
        <span class="gift-link__text anchor"><?=Loc::getMessage('RS.MASTER.BSPG_DETAIL.PRODUCT_GIFT')?></span>
        <span class="gift-link__icon">
            <svg class="icon-svg"><use xlink:href="#svg-gift"></use></svg>
        </span>
    </a>
<?php $this->EndViewTarget(); ?>