							...
							foreach ($arParams['PRODUCT_INFO_BLOCK_ORDER'] as $blockName)
							{
								...
								switch ($blockName)
								{
									...
									case 'brand-gift':
                                        ...
                                        if (
                                            $arParams['BRAND_USE'] === 'Y' && isset($arResult['BRANDS'][$arResult['PROPERTIES'][$sBrandPropCode]['VALUE']])
...
*/
                                            ...
                                            include(MyTemplate::getTemplatePart($templateFolder.'/include/prop/list.php'));

                                        } else {

                                            include(MyTemplate::getTemplatePart($templateFolder.'/include/prop/default.php'));
