...
if (!empty($arResult['RECOMMENDED_IDS']))
{
	...
	$APPLICATION->IncludeComponent(
		...
		array(
            ...
            'SHOW_PARENT_NAME' => !isset($arParams['SHOW_PARENT_NAME']) || $arParams['SHOW_PARENT_NAME'] !== 'N' ? 'Y' : 'N',
            'PARENT_NAME' => $arParams['PARENT_NAME'] ?: Loc::getMessage('CT_BCE_CATALOG_GIFT_BLOCK_TITLE_DEFAULT'),
		),
		$component,
		array('HIDE_ICONS' => 'Y')
	);
