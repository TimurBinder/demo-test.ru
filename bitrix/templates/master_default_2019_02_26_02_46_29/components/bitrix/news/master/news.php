...
if (
    ...
    $APPLICATION->IncludeComponent(
        ...
        Array(
            ...
            "ELEMENT_SORT_FIELD" => strtolower($arParams["SORT_BY1"]),
            "ELEMENT_SORT_FIELD2" => strtolower($arParams["SORT_BY2"]),
            "ELEMENT_SORT_ORDER" => strtolower($arParams["SORT_ORDER1"]),
            "ELEMENT_SORT_ORDER2" => strtolower($arParams["SORT_ORDER2"]),
            ...
            "RS_STAFF_ASK_B24_CRM_FORM_USE" => (isset($arParams["RS_STAFF_ASK_B24_CRM_FORM_USE"]) ? $arParams["RS_STAFF_ASK_B24_CRM_FORM_USE"] : '') ,
        		"RS_STAFF_ASK_B24_CRM_FORM_ID" => (isset($arParams["RS_STAFF_ASK_B24_CRM_FORM_ID"]) ? $arParams["RS_STAFF_ASK_B24_CRM_FORM_ID"] : ''),
        		"RS_STAFF_ASK_B24_CRM_FORM_SEC" => (isset($arParams["RS_STAFF_ASK_B24_CRM_FORM_SEC"]) ? $arParams["RS_STAFF_ASK_B24_CRM_FORM_SEC"] : ''),
            "RS_STAFF_ASK_B24_FORM_STAFF_NAME_PARAM" => (isset($arParams["RS_STAFF_ASK_B24_FORM_STAFF_NAME_PARAM"]) ? $arParams["RS_STAFF_ASK_B24_FORM_STAFF_NAME_PARAM"] : ''),
        ),
        $component,
        array('HIDE_ICONS' => 'Y')
    );
