...
*/
    ...
    ParametersUtils::addB24CRMFormsParameters(Loc::getMessage('RS.MI_FORM_NAME'), 'STAFF_ASK', $arTemplateParameters, $arCurrentValues);
    if ($arCurrentValues['RS_STAFF_ASK_B24_CRM_FORM_USE'] == 'Y') {
        $arTemplateParameters['RS_STAFF_ASK_B24_FORM_STAFF_NAME_PARAM'] = array(
            'NAME' => Loc::getMessage('RS.STAFF_ASK_B24_FORM_STAFF_NAME_PARAM'),
            'TYPE' => 'STRING',
            'DEFAULT' => 'my_param1'
        );
    }
