...
$arTemplateParameters = array(
	'DISPLAY_DATE' => Array(
		'NAME' => getMessage('RS.MASTER.NEWS_DATE'),
		'TYPE' => 'CHECKBOX',
		'DEFAULT' => 'Y',
	),
	'DISPLAY_NAME' => Array(
		'NAME' => getMessage('RS.MASTER.NEWS_NAME'),
		'TYPE' => 'CHECKBOX',
		'DEFAULT' => 'Y',
	),
	'DISPLAY_PICTURE' => Array(
		'NAME' => getMessage('RS.MASTER.NEWS_PICTURE'),
		'TYPE' => 'CHECKBOX',
		'DEFAULT' => 'Y',
	),
	'DISPLAY_PREVIEW_TEXT' => Array(
		'NAME' => getMessage('RS.MASTER.NEWS_TEXT'),
		'TYPE' => 'CHECKBOX',
		'DEFAULT' => 'Y',
	),
	'GROUP_BY_ABC' => array(
		'NAME' => getMessage('RS.MASTER.GROUP_BY_ABC'),
		'TYPE' => 'CHECKBOX',
		'DEFAULT' => 'N',
	),
	'SHOW_PARENT' => array(
		'NAME' => getMessage('RS.MASTER.SHOW_PARENT'),
		'TYPE' => 'CHECKBOX',
		'DEFAULT' => 'Y',
	),
	'SECTION_PAGE_MORE_URL' => array(
		'NAME' => getMessage('RS.MASTER.SECTION_PAGE_MORE_URL'),
		'TYPE' => 'STRING',
		'DEFAULT' => '',
	),
	'SECTION_PAGE_MORE_TEXT' => array(
		'NAME' => getMessage('RS.MASTER.SECTION_PAGE_MORE_TEXT'),
		'TYPE' => 'STRING',
		'DEFAULT' => getMessage('RS.MASTER.SECTION_PAGE_MORE_DEFAULT'),
	),
	'LINKED_PROP' => array(
		'NAME' => getMessage('RS.MASTER.LINKED_PROP'),
		'TYPE' => 'LIST',
...
if (0 < $CATALOG_IBLOCK_ID) {
	...
	$arTemplateParameters['CATALOG_URL'] = array(
		'NAME' => getMessage('RS.MASTER.CATALOG_URL'),
		'TYPE' => 'STRING',
		'DEFAULT' => 'catalog/',
	);
	$arTemplateParameters['CATALOG_FILTER_NAME'] = array(
		'NAME' => getMessage('RS.MASTER.CATALOG_FILTER_NAME'),
		'TYPE' => 'STRING',
		'DEFAULT' => 'arrFilter',
	);
	$arTemplateParameters['CATALOG_LINKED_PROP'] = array(
		'NAME' => getMessage('RS.MASTER.CATALOG_LINKED_PROP'),
		'TYPE' => 'LIST',
