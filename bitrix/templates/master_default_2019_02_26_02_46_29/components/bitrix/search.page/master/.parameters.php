...
if (isset($arCurrentValues['CATALOG_IBLOCK_ID']) && (int)$arCurrentValues['CATALOG_IBLOCK_ID'] > 0)
{
	...
	if (!empty($arCurrentValues['CATALOG_PROPERTY_CODE']))
	{
		$selected = array();

		foreach ($arCurrentValues['CATALOG_PROPERTY_CODE'] as $code)
		{
...
/*
	...
	if (isset($arCurrentValues['CATALOG_SHOW_DISCOUNT_PERCENT']) && $arCurrentValues['CATALOG_SHOW_DISCOUNT_PERCENT'] === 'Y')
	{
		$arTemplateParameters['CATALOG_DISCOUNT_PERCENT_POSITION'] = array(
			'PARENT' => 'VISUAL',
