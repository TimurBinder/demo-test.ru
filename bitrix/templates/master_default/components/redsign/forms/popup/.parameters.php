    ...
    'JS_DATA' => str_replace('\'', '"', CUtil::PhpToJSObject(
        array(
            ...
            'labels' => array(
                ...
                'placeholder' => Loc::getMessage('RS.FORMS_PARAMETERS_LABEL_PLACEHOLDER'),
            )
        )
    )),
  'DEFAULT' => '',
...
$arTemplateParameters['USE_B24_CRM_FORM'] = array(
    'NAME' => Loc::getMessage('RS.USE_B24_CRM_FORM'),
    'TYPE' => 'CHECKBOX',
    'DEFAULT' => 'N',
    'REFRESH' => 'Y'
);
if ($arCurrentValues['USE_B24_CRM_FORM'] == 'Y') {
    $arTemplateParameters['B24_CRM_FORM_ID'] = array(
        'NAME' => Loc::getMessage('RS.B24_CRM_FORM_ID'),
        'TYPE' => 'STRING',
        'DEFAULT' => ''
    );
    $arTemplateParameters['B24_CRM_FORM_SEC'] = array(
        'NAME' => Loc::getMessage('RS.B24_CRM_FORM_SEC'),
        'TYPE' => 'STRING',
        'DEFAULT' => ''
    );
}
