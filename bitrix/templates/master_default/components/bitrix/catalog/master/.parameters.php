...
*/
		...
		if ($arCurrentValues['USE_FILTER'] == 'Y')
		{
			$arTemplateParameters['OFFER_FILTER_SCROLL_PROPS'] = array(
				...
				'NAME' => getMessage('RS.MASTER.OFFER_FILTER_SCROLL_PROPS'),
				'TYPE' => 'LIST',
				'VALUES' => $defaultValue + $arAllOfferPropList,
				'MULTIPLE' => 'Y',
				'DEFAULT' => '-',
			...
			$arTemplateParameters['OFFER_FILTER_SEARCH_PROPS'] = array(
				'PARENT' => 'FILTER_SETTINGS',
				'NAME' => getMessage('RS.MASTER.OFFER_FILTER_SEARCH_PROPS'),
				'TYPE' => 'LIST',
				'VALUES' => $defaultValue + $arAllOfferPropList,
				'MULTIPLE' => 'Y',
				'DEFAULT' => '-',
...
if (Loader::includeModule('redsign.master'))
{
	$arTemplateParameters['LIST_TEMPLATE'] = array(
		...
		'DEFAULT' => 'master', // in_array('master', $arCSTemplates) ? 'master' : $arCSTemplates[0],
		'REFRESH' => 'Y',
	);
	...
	$arTemplateParameters['DETAIL_TEMPLATE'] = array(
		...
		'DEFAULT' => 'master', // in_array('master', $arCETemplates) ? 'master' : $arCETemplates[0],
		'REFRESH' => 'Y',
	);
...
if ($arCurrentValues['USE_PRODUCT_QUANTITY'] == 'Y')
{
	$arTemplateParameters['LIST_USE_PRODUCT_QUANTITY'] = array(
		'PARENT' => 'BASKET',
		'NAME' => Loc::getMessage('RS.MASTER.LIST_USE_PRODUCT_QUANTITY'),
		'TYPE' => 'CHECKBOX',
		'DEFAULT' => 'N',
		'REFRESH' => 'Y',
	);
	...
	$arTemplateParameters['DETAIL_USE_PRODUCT_QUANTITY'] = array(
		'PARENT' => 'BASKET',
		'NAME' => Loc::getMessage('RS.MASTER.DETAIL_USE_PRODUCT_QUANTITY'),
		'TYPE' => 'CHECKBOX',
		'DEFAULT' => 'N',
		'REFRESH' => 'Y',
	);
...
if (ModuleManager::isModuleInstalled('redsign.devcom'))
{
	...
	if ($arCurrentValues['USE_SORTER'] == 'Y')
	{
		$arTemplateParameters['SORTER_TEMPLATE'] = array(
			...
			'DEFAULT' => 'master', // in_array('master', $arRCSTemplates) ? 'master' : $arRCSTemplates[0],
			'REFRESH' => 'Y',
		);
