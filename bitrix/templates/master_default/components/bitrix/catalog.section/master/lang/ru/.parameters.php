...
$MESS["RS.MASTER.PRODUCT_BLOCKS"] = "Отображаемые блоки товара";
...
$MESS["RS_SECTION_SHOW_BUTTON"] = "Показывать кнопку";
$MESS["RS_SECTION_BUTTON_NAME"] = "Заголовок кнопки";
$MESS["RS_SECTION_BUTTON_LINK"] = "Ссылка кнопки";
$MESS["RS_MASTER_SHOW_ERROR_SECTION_EMPTY"] = "Показывать ошибку, если элементов не найдено";
$MESS["RS_MASTER_MESS_ERROR_SECTION_EMPTY"] = "Текст ошибки об отсутствии элементов";
$MESS["RS_MASTER_MESS_ERROR_SECTION_EMPTY_DEFAULT"] = "В данном разделе элементов не найдено";
?>