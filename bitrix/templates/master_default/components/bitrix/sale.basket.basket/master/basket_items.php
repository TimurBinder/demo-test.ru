							...
							<td class="control">
								...
								if ($bDeleteColumn):
									...
									<a href="<?=str_replace("#ID#", $arItem["ID"], $arUrls["delete"])?>"
										...
										<svg class="icon-svg"><use xlink:href="#svg-cross"></use></svg><?=GetMessage("SALE_DELETE")?></a>
									<br />
									<?
								endif;
								if ($bDelayColumn):
								?>
									<a href="<?=str_replace("#ID#", $arItem["ID"], $arUrls["delay"])?>"><svg class="icon-svg"><use xlink:href="#svg-delay"></use></svg><?=GetMessage("SALE_DELAY")?></a>
								<?
								endif;
								?>
							</td>
...
<div id="basket_items_list" >
          ...
          <div class="b-cart-empty">
              ...
              <h2 class="b-cart-empty__title"><?=GetMessage("SALE_NO_ITEMS")?></h2>
