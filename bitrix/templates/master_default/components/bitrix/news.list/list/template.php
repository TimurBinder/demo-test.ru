...
<div class="b-newslist">
    <?php if ($arParams['ADD_CONTAINER'] == 'Y'): ?> <div class="container"> <?php endif; ?>
        <?php if (isset($arParams['RS_SHOW_TITLE']) && $arParams['RS_SHOW_TITLE'] == 'Y'): ?>
            ...
            <h2 class="b-newslist__title"><?=$arParams['RS_TITLE']?></h2>
            <?php else: ?>
        ...
        <div class="b-newslist__items owl owl-carousel owl-theme owl-master" data-slider="true" data-slider-options='<?=\Bitrix\Main\Web\Json::encode($arParams['OWL_PARAMS'])?>'>
        <?php else: ?>
                ...
                <div class="b-newslist__item" id="<?=$this->GetEditAreaId($arItem['ID']);?>" itemscope itemtype="http://schema.org/NewsArticle">
                    ...
                    <div class="b-newslist__data">
                        <?php if (!is_null($arItem['DISPLAY_ACTIVE_FROM_FORMATED'])): ?>
                          <time class="b-newslist__date" itemprop="datePublished"><?=$arItem['DISPLAY_ACTIVE_FROM_FORMATED']?></time>
                        <?php endif; ?>
                        <div class="b-newslist__datainner">
                            <h5><a href="<?=$arItem['DETAIL_PAGE_URL']?>" class="b-newslist__name" itemprop="name"><?=$arItem['NAME']?></a></h5>
