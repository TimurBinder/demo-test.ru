	...
	<section>
        ...
        */
        ...
        <div>
            ...
            $arDeleteParams = array('CONFIRM' => getMessage('RS.MASTER.BNL_TILES.ELEMENT_DELETE_CONFIRM'));
            ?>
		...
		<?php if ($arParams['SECTION_PAGE_MORE_URL']): ?>
			<a class="rs_more_link" href="<?=$arParams['SECTION_PAGE_MORE_URL']?>"><?=(strlen($arParams['SECTION_PAGE_MORE_TEXT']) > 0 ? $arParams['SECTION_PAGE_MORE_TEXT'] : getMessage('RS.MASTER.BNL_TILES.MORE_LINK'))?></a>
		<?php endif; ?>
