...
$MESS["SALE_NO_ITEMS_NOTE"] = "Исправить это просто - посетите наш каталог продукции и наполните корзину нужными товарами";
$MESS["SALE_REFRESH"] = "Пересчитать";
$MESS["SALE_COUPON_APPLY"] = "Проверить";
$MESS["SALE_COUPON_APPLY_TITLE"] = "Нажмите для применения нового купона";
$MESS["SALE_CLEAR_BUTTON"] = "Очистить корзину";
?>
