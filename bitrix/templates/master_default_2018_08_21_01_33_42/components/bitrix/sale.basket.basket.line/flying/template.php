...
?>
    <svg class="icon-svg"><use xlink:href="#svg-cart-main"></use></svg><span class="b-topline-cart__text"><?=Loc::getMessage('RS_LIGHTBASKET_CART');?></span><span class="b-topline-cart__count js-cart-count"><?=$arResult['NUM_PRODUCTS']?></span>
<?php $frame->beginStub(); ?>
    <svg class="icon-svg"><use xlink:href="#svg-cart-main"></use></svg><span class="b-topline-cart__text"><?=Loc::getMessage('RS_LIGHTBASKET_CART');?></span><span class="b-topline-cart__count js-cart-count">0</span>
<?php $frame->end(); ?>
</a>
<?php $this->EndViewTarget(); ?>
