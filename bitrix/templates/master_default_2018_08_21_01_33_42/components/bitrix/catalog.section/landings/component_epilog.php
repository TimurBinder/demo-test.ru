...
$asset->addJs(SITE_TEMPLATE_PATH.'/components/bitrix/news.list/faq/script.js');
...
$asset->addJs(SITE_TEMPLATE_PATH.'/assets/vendor/waypoints/jquery.waypoints.min.js');
//$asset->addJs(SITE_TEMPLATE_PATH.'/assets/vendor/jquery.easypiechart/jquery.easypiechart.min.js');
...
$asset->addCss(SITE_TEMPLATE_PATH.'/components/bitrix/news.list/faq/style.css');
    ...
    <div class="landing__crop_settings">
        <div class="landing__setting" data-iblocktype="<?=$templateData["IBLOCK_TYPE_ID"]?>" data-iblockid="<?=$templateData["IBLOCK_ID"]?>">
            <a href="" class="landing__setting__link" target="_blank">
                <svg class="landing__setting__svg icon-svg"><use xlink:href="#svg-settings"></use></svg>
            </a>
        </div>
    </div>
<?php endif;
