				...
				case 'buttons':
					...
					<div class="product-item-info-container" data-entity="buttons-block">
						...
						if (!$haveOffers)
						{
							...
							{
								?>
								<div class="product-item-button-container js-buy" id="<?=$itemIds['BASKET_ACTIONS']?>">
						...
						else
						{
							if ($arParams['PRODUCT_DISPLAY_MODE'] === 'Y')
							{
								...
								<div class="product-item-button-container">
									...
									<div class="js-buy" id="<?=$itemIds['BASKET_ACTIONS']?>" style="display: <?=($actualItem['CAN_BUY'] ? '' : 'none')?>;">
										<a class="btn btn-primary <?=$buttonSizeClass?> js-buy__add2cart" id="<?=$itemIds['BUY_LINK']?>"
											href="javascript:void(0)" rel="nofollow">
											<?=($arParams['ADD_TO_BASKET_ACTION'] === 'BUY' ? $arParams['MESS_BTN_BUY'] : $arParams['MESS_BTN_ADD_TO_BASKET'])?>
										</a>
