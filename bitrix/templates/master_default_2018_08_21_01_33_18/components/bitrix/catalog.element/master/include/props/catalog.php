...
?>
 <?$APPLICATION->IncludeComponent(
    ...
    array(
        ...
        'PROPERTY_CODE_'.$arSKU[$IBLOCK_ID] => $arParams['LIST_OFFERS_PROPERTY_CODE'],
        'CART_PROPERTIES_'.$arParams['IBLOCK_ID'] => $arParams['PRODUCT_PROPERTIES'],
        'CART_PROPERTIES_'.$arSKU[$IBLOCK_ID] => $arParams['OFFERS_CART_PROPERTIES'],
        'OFFER_TREE_PROPS_'.$arSKU[$IBLOCK_ID] => $arParams['OFFER_TREE_PROPS'],
        'ADDITIONAL_PICT_PROP_'.$arParams['IBLOCK_ID'] => $arParams['ADD_PICT_PROP'],
        'ADDITIONAL_PICT_PROP_'.$arSKU[$IBLOCK_ID] => $arParams['OFFER_ADD_PICT_PROP'],
        ...
        'SHOW_PARENT_NAME' => 'N',
        'PARENT_NAME' => $arResult['PROPERTIES'][$sPropCode]['NAME'],
    ),
    $component,
    array('HIDE_ICONS' => 'Y')
);?>