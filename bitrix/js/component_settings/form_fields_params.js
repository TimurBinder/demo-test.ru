...
function FormFieldsParamSettings(params)
{
    ...
    this.fields.forEach(BX.delegate(function (field) {
        ...
        if(!this.fieldsParams[field.ID].placeholder){
          this.fieldsParams[field.ID].placeholder = '';
        }
...
FormFieldsParamSettings.prototype.addField = function (field) {
    ...
    var block = this.element.appendChild(BX.create('div', {
        ...
        children: [
            ...
            BX.create('div', {
                children: [
                    BX.create('label', {text: this.labels.placeholder}),
                    BX.create('br'),
                    BX.create('input', {
                        props: {
                            className: "sps-params-input-values",
                        ...
                        attrs: {
                            type: "text",
                            value: this.fieldsParams[field.ID].placeholder
                        },
                         events: {
                            change: function () {
                                that.fieldsParams[field.ID]['placeholder'] = this.value;
                                that.updateFieldParams();
                            }
                        }
                    })
