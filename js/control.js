...
$('div.non_active').click(function(){
    ...
    $('#bott1').removeClass('remove_after');
    $('#bott2').removeClass('remove_after');
    $('#bott3').removeClass('remove_after');
    $('#bott4').removeClass('remove_after');
    $('#bott5').removeClass('remove_after');
    $('#bott6').removeClass('remove_after');
...
$('#bott2').click(function(){
    ...
    $('#bott1').removeClass('remove_after');
    $('#bott2').toggleClass('remove_after');
    $('#bott3').removeClass('remove_after');
    $('#bott4').removeClass('remove_after');
    $('#bott5').removeClass('remove_after');
    $('#bott6').removeClass('remove_after');
...
$('#bott3').click(function(){
    ...
    $('#bc1').removeClass('content_active');
    $('#bc2').removeClass('content_active_2');
    $('.non_active_3').toggleClass('active_over');     
    $('.non_active_4').removeClass('active_over');
    $('.non_active_5').removeClass('active_over');
    $('.non_active_6').removeClass('active_over');     
    $('.non_active').removeClass('active_over');     
    ...
    $('#bott1').removeClass('remove_after');
    $('#bott2').removeClass('remove_after');
    $('#bott3').toggleClass('remove_after');
    $('#bott4').removeClass('remove_after');
    $('#bott5').removeClass('remove_after');
    $('#bott6').removeClass('remove_after');
});
$('#bott4').click(function(){
    ...
    $('#bc2').removeClass('content_active_2');
    $('#bc3').removeClass('content_active_3');
    $('.non_active_4').toggleClass('active_over');       
    $('.non_active_5').removeClass('active_over');
    $('.non_active_6').removeClass('active_over');   
    $('.non_active').removeClass('active_over');
    $('.non_active_2').removeClass('active_over');
    ...
    $('#bott2').removeClass('remove_after');
    $('#bott3').removeClass('remove_after');
    $('#bott4').toggleClass('remove_after');
    $('#bott5').removeClass('remove_after');
    $('#bott6').removeClass('remove_after');
});
$('#bott5').click(function(){
    ...
    $('#bott3').removeClass('remove_after');
    $('#bott4').removeClass('remove_after');
    $('#bott5').toggleClass('remove_after');
    $('#bott6').removeClass('remove_after');
});
$('#bott6').click(function(){
    $('#bc6').toggleClass('content_active_6');       
    $('#bc1').removeClass('content_active');
    $('#bc2').removeClass('content_active_2');
    $('#bc3').removeClass('content_active_3');
    $('#bc4').removeClass('content_active_4');
    ...
    $('#bott4').removeClass('remove_after');
    $('#bott5').removeClass('remove_after');
    $('#bott6').toggleClass('remove_after');
});
